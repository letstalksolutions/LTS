...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const mainNavList = document.querySelector('.site-nav__list');
  ...
  if (mobileMenuToggle && mainNavList) {
    mobileMenuToggle.addEventListener('click', () => {
      ...
      if (!isExpanded) {
        ...
        const firstLink = mainNavList.querySelector('.site-nav__link');
        if (firstLink) {
    ...
    const navLinks = mainNavList.querySelectorAll('.site-nav__link');
